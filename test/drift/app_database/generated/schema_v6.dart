...
class CategoryRules extends Table
    with TableInfo<CategoryRules, CategoryRulesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  CategoryRulesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class CategoryRulesData extends DataClass
    implements Insertable<CategoryRulesData> {
  final String id;
  ...
  factory CategoryRulesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CategoryRulesData copyWithCompanion(CategoryRulesCompanion data) {
    return CategoryRulesData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('CategoryRulesData(')
          ..write('id: $id, ')
...
class CategoryRulesCompanion extends UpdateCompanion<CategoryRulesData> {
  final Value<String> id;
  ...
  CategoryRulesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       categoryName = Value(categoryName),
       createdAt = Value(createdAt);
  static Insertable<CategoryRulesData> custom({
    Expression<String>? id,
...
class TransactionImages extends Table
    with TableInfo<TransactionImages, TransactionImagesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {transactionId};
  @override
  TransactionImagesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TransactionImagesData(
      transactionId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}transaction_id'],
      )!,
...
class TransactionImagesData extends DataClass
    implements Insertable<TransactionImagesData> {
  final String transactionId;
  final String imagePath;
  final int updatedAt;
  const TransactionImagesData({
    required this.transactionId,
  ...
  factory TransactionImagesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TransactionImagesData copyWith({
    String? transactionId,
    String? imagePath,
    int? updatedAt,
  }) => TransactionImagesData(
    transactionId: transactionId ?? this.transactionId,
    imagePath: imagePath ?? this.imagePath,
    updatedAt: updatedAt ?? this.updatedAt,
  );
  TransactionImagesData copyWithCompanion(TransactionImagesCompanion data) {
    return TransactionImagesData(
      transactionId: data.transactionId.present
          ? data.transactionId.value
          : this.transactionId,
  ...
  @override
  String toString() {
    return (StringBuffer('TransactionImagesData(')
          ..write('transactionId: $transactionId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TransactionImagesData &&
          other.transactionId == this.transactionId &&
          other.imagePath == this.imagePath &&
          other.updatedAt == this.updatedAt);
}

class TransactionImagesCompanion
    extends UpdateCompanion<TransactionImagesData> {
  final Value<String> transactionId;
  ...
  TransactionImagesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       imagePath = Value(imagePath),
       updatedAt = Value(updatedAt);
  static Insertable<TransactionImagesData> custom({
    Expression<String>? transactionId,
