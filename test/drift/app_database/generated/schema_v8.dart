...
class ImageRules extends Table with TableInfo<ImageRules, ImageRulesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ImageRulesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ImageRulesData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
...
class ImageRulesData extends DataClass implements Insertable<ImageRulesData> {
  final String id;
  final String matchText;
  final int exact;
  final String imagePath;
  final int createdAt;
  const ImageRulesData({
    required this.id,
    required this.matchText,
    required this.exact,
  ...
  factory ImageRulesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ImageRulesData copyWithCompanion(ImageRulesCompanion data) {
    return ImageRulesData(
      id: data.id.present ? data.id.value : this.id,
      matchText: data.matchText.present ? data.matchText.value : this.matchText,
  ...
  @override
  String toString() {
    return (StringBuffer('ImageRulesData(')
          ..write('id: $id, ')
          ..write('matchText: $matchText, ')
          ..write('exact: $exact, ')
...
class ImageRulesCompanion extends UpdateCompanion<ImageRulesData> {
  final Value<String> id;
  final Value<String> matchText;
  ...
  ImageRulesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       imagePath = Value(imagePath),
       createdAt = Value(createdAt);
  static Insertable<ImageRulesData> custom({
    Expression<String>? id,
    Expression<String>? matchText,
